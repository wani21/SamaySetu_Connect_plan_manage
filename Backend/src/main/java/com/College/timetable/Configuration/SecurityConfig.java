...
public class SecurityConfig {
	...
	public SecurityFilterChain httpSecurityFilter(HttpSecurity http) throws Exception{
		...
		.authorizeHttpRequests(auth->auth
					...
					.requestMatchers("/api/teachers/profile").hasAnyRole("TEACHER", "ADMIN", "SUPER_ADMIN", "DEPARTMENT_ADMIN", "HOD", "TIMETABLE_COORDINATOR")
					.requestMatchers("/api/teachers/pending-approvals").hasAnyRole("ADMIN", "SUPER_ADMIN", "DEPARTMENT_ADMIN", "HOD")
					.requestMatchers("/api/teachers/*/approve", "/api/teachers/*/reject").hasAnyRole("ADMIN", "SUPER_ADMIN", "DEPARTMENT_ADMIN", "HOD")
					.requestMatchers("/api/teachers/**").hasAnyRole("TEACHER", "ADMIN", "SUPER_ADMIN", "DEPARTMENT_ADMIN", "HOD", "TIMETABLE_COORDINATOR")
					// Faculty endpoints
					.requestMatchers("/api/faculty/**").hasAnyRole("TEACHER", "ADMIN", "SUPER_ADMIN", "DEPARTMENT_ADMIN", "HOD", "TIMETABLE_COORDINATOR")
					// Admin panel — ADMIN has full access, HOD and COORDINATOR have partial
					.requestMatchers("/admin/upload-staff", "/admin/create-staff", "/admin/update-staff/**", "/admin/download-staff-template").hasAnyRole("ADMIN", "SUPER_ADMIN", "DEPARTMENT_ADMIN", "HOD")
					.requestMatchers("/admin/upload-courses", "/admin/download-courses-template").hasAnyRole("ADMIN", "SUPER_ADMIN", "DEPARTMENT_ADMIN", "HOD")
					.requestMatchers("/admin/api/**").hasAnyRole("ADMIN", "SUPER_ADMIN", "DEPARTMENT_ADMIN", "HOD", "TIMETABLE_COORDINATOR")
					.requestMatchers("/admin/**").hasAnyRole("ADMIN", "SUPER_ADMIN", "DEPARTMENT_ADMIN", "HOD", "TIMETABLE_COORDINATOR")
